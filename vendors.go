...
func (v VendorId) Name() string {
	if name, ok := cipVendorNames[v]; ok {
		return name
	}
...
// List of vendors from the CIP vendor ID list.
...
var cipVendorNames = map[VendorId]string{
	...
	1452: "Reserved",
	1453: "Reserved",
	1454: "Altus Sistemas de AutomaÃ§Ã£o S.A.",
	1455: "Reserved",
	...
	1601: "IngenieurbÃ¼ro Mewes & Partner GmbH",
	...
	1677: "JingQiï¼ˆTianjinï¼‰technology Co.,Ltd",
	1678: "AGI Suretrack",
